...
<div class="h-full flex items-center">
	...
	>
		<form method="POST">
			<h2 class="font-display text-6xl text-center mb-8">Register</h2>
			<div class="flex flex-col justify-center">
				...
				<div class="flex flex-col items-center">
					...
					<p class="text-center mt-6">
						...
						<a href="/login" class="text-blue-400 hover:text-blue-600"> Login here</a>
					</p>
				</div>
			</div>
		</form>
